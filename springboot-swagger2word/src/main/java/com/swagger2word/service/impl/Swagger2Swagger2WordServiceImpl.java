package com.swagger2word.service.impl;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.swagger2word.bean.ModelAttr;
import com.swagger2word.bean.Request;
import com.swagger2word.bean.Response;
import com.swagger2word.bean.Table;
import com.swagger2word.service.ISwagger2WordService;
import com.swagger2word.utils.JsonUtils;
 ...
 * @description:
 * @author: QL Zhang
 * @time: 2020/08/13 11:16
 **/
@SuppressWarnings({"unchecked", "rawtypes"})
@Slf4j
@Service
public class Swagger2Swagger2WordServiceImpl implements ISwagger2WordService {
    ...
    public Map<String, Object> tableList(String swaggerUrl) {
        ...
        try {
            ...
            log.error("tableList parse error", e);
        }
        return resultMap;
    }
    ...
    public Map<String, Object> tableListFromString(String jsonStr) {
        ...
        try {
            ...
            log.error("tableListFromString parse error");
        }
        return resultMap;
    }
    ...
    /*private Map<String, Object> getResultFromString(List<TableEntity> result, String jsonStr) throws IOException {
        // convert JSON string to Map
        Map<String, Object> map = JsonUtils.readValue(jsonStr, HashMap.class);
